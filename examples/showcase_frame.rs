...
fn build_showcase_scene() -> SceneGraph {
    ...
    let title = scene
        .create_node_with_transform("Title".into(), Transform::from_translation(0.0, 0.75, 0.0));
    scene
        .get_node_mut(title)
        .unwrap()
    ...
    let circle3 = scene
        .create_node_with_transform("Circle3".into(), Transform::from_translation(0.2, 0.2, 0.0));
    scene
        .get_node_mut(circle3)
        .unwrap()
        .set_renderable(Renderable::Circle {
            radius: 0.12,
    ...
    let circle4 = scene
        .create_node_with_transform("Circle4".into(), Transform::from_translation(0.6, 0.2, 0.0));
    scene
        .get_node_mut(circle4)
        .unwrap()
        .set_renderable(Renderable::Circle {
            radius: 0.12,
    ...
    let eq1 = scene
        .create_node_with_transform("Eq1".into(), Transform::from_translation(-0.5, -0.15, 0.0));
    scene
        .get_node_mut(eq1)
        .unwrap()
    ...
    let eq2 = scene
        .create_node_with_transform("Eq2".into(), Transform::from_translation(0.2, -0.15, 0.0));
    scene
        .get_node_mut(eq2)
        .unwrap()
        .set_renderable(Renderable::Math {
    ...
    let eq3 = scene
        .create_node_with_transform("Eq3".into(), Transform::from_translation(-0.5, -0.45, 0.0));
    scene
        .get_node_mut(eq3)
        .unwrap()
        .set_renderable(Renderable::Math {
    ...
    let eq4 = scene
        .create_node_with_transform("Eq4".into(), Transform::from_translation(0.25, -0.45, 0.0));
    scene
        .get_node_mut(eq4)
        .unwrap()
        .set_renderable(Renderable::Math {
    ...
    // Bottom text
    let tech = scene
        .create_node_with_transform("Tech".into(), Transform::from_translation(0.0, -0.85, 0.0));
    scene
        .get_node_mut(tech)
        .unwrap()
        .set_renderable(Renderable::Text {
